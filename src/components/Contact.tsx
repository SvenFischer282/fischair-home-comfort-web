...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const serviceId = "service_2bfgkh8"; // Replace with your EmailJS service ID
      const templateId = "template_qynyfml"; // Replace with your EmailJS template ID
      const publicKey = "hFia3H_h7ympY0CpI"; // Replace with your EmailJS public key
      ...
      toast({
        title: "Chyba",
        description:
          "Nepodarilo sa odoslať správu. Skúste to prosím znovu alebo nás kontaktujte priamo.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {contactInfo.map((info, index) => (
                  <Card
                    key={index}
                    className="hover:shadow-lg transition-shadow bg-gradient-to-br from-card to-secondary/20 border-0 shadow-md"
                  >
            ...
            <Card className="bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-primary" />
                  <span className="text-foreground">
                    Pomoc s výberom najvhodnejšieho riešenia
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-primary" />
                  <span className="text-foreground">
                    Informácie o dostupných dotáciách
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-primary" />
                  <span className="text-foreground">
                    Technické poradenstvo od odborníkov
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-xl bg-gradient-to-br from-card to-secondary/20 border-0">
              ...
              <CardContent className="space-y-6">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-6">
                    ...
                    >
                      ...
                      <option value="Kombinácia riešení">
                        Kombinácia riešení
                      </option>
                      <option value="Nezáväzná konzultácia">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  * Povinné polia. Vaše údaje sú v bezpečí a nebudú zdieľané s
                  tretími stranami.
                </p>
              </CardContent>
            </Card>
