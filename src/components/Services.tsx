  ...
  const services = [
    {
      ...
      fallbackIcon: Wind,
      title: 'Rekuperácie',
      description: 'Zdravý vzduch bez tepelných strát. Vhodné pre novostavby aj rekonštrukcie.',
      features: [
    ...
    },
    {
      ...
      description: 'Ekologické a úsporné vykurovanie s návratnosťou investície už od pár rokov.',
      features: [
    ...
    },
    {
      ...
      title: 'Klimatizácie',
      description: 'Pohodlie počas celého roka – chladenie aj kúrenie modernou klimatizáciou.',
      features: [
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Ponúkame komplexné riešenia pre zdravé a energeticky efektívne bývanie. 
            Každý projekt navrhujeme individuálne podľa vašich potrieb.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {services.map((service, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-gradient-to-br from-card to-secondary/20 border-0 shadow-lg">
              <CardHeader className="text-center pb-4">
                <div className={`w-20 h-20 mx-auto mb-4 p-4 rounded-2xl ${service.bgColor} group-hover:scale-110 transition-transform duration-300`}>
                  <img 
                    src={service.icon} 
                    alt={service.title}
        ...
        <div className="text-center">
          <Button size="lg" className="bg-gradient-to-r from-primary to-primary-light shadow-lg hover:shadow-xl">
